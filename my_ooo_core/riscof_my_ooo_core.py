...
class my_ooo_core(pluginTemplate):
    __model__ = "my_ooo_core"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(self.root_dir, "obj_dir", "Vcpu")
        self.bin2hex = os.path.join(self.root_dir, "bin2hex.py")
        self.run_dut_sh = os.path.join(self.root_dir, "run_dut.sh")
    ...
    def runTests(self, testList):
      ...
      for testname in testList:
          ...
          if self.target_run:
            simcmd = f'bash {self.run_dut_sh} {elf} {sig_file} {self.dut_exe} {self.bin2hex}'
          else:
            simcmd = 'echo "NO RUN"'
